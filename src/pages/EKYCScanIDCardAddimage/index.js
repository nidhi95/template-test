        ...
        >
          ...
          >
            <Img
              ...
              compId="I43812:48182;43807:13258"
              comWidth={21}
              comHeight={28}
              compLeft={0}
              compRight={0}
            ...
            <Text
              ...
              compId="I43812:48182;234:259667"
              comWidth={133}
              comHeight={22}
              compLeft={218}
              compRight={0}
            ...
            <Input
              ...
              compId="I43812:48182;234:259514"
              comWidth={0}
              comHeight={40}
              compLeft={0}
              compRight={0}
              ...
              prefix={
                <Img
                  ...
                  compId="I43812:48182;234:259514;234:259505"
                  comWidth={20}
                  comHeight={20}
                  compLeft={16}
                  compRight={8}
            ...
            <Img
              ...
              compId="I43812:48182;531:315836;5:32"
              comWidth={20}
              comHeight={22}
              compLeft={136}
              compRight={0}
            ...
            >
              <Img
                ...
                compId="I43812:48182;37:1285;37:1283"
                comWidth={18}
                comHeight={20}
                compLeft={0}
                compRight={0}
              ...
              >
                <div
                  ...
                  compId="I43812:48182;530:301660"
                  comWidth={8}
                  comHeight={8}
                  compLeft={0}
                  compRight={0}
            ...
            <Img
              ...
              compId="I43812:48182;483:292004;43812:47214"
              comWidth={40}
              comHeight={40}
              compLeft={13}
              compRight={13}
          ...
          >
            ...
            >
              ...
              >
                <Column
                  className="border-2 border-dashed border-indigo_50 items-center lg:p-[26px] xl:p-[30px] p-[34px] 3xl:p-[40px] rounded-radius4 w-[49%]"
                  compId="530:294524"
                  comWidth={533}
                  comHeight={359}
                  compLeft={0}
                ...
                >
                  <Column
                    className="bg-cover bg-repeat items-end justify-end lg:p-[21px] xl:p-[24px] p-[27px] 3xl:p-[32px] w-[99%]"
                    compId="262"
                    style={{
                      backgroundImage: "url('images/img_group262.png')",
                    }}
                    comWidth={461}
                    comHeight={291}
                    compLeft={0}
                  ...
                  >
                    <Button
                      className="flex lg:h-[42px] xl:h-[49px] h-[54px] 2xl:h-[55px] 3xl:h-[65px] items-center justify-center mb-[3px] lg:mt-[140px] xl:mt-[160px] mt-[180px] 3xl:mt-[216px] lg:w-[42px] xl:w-[48px] w-[54px] 3xl:w-[64px]"
                      compId="530:294527"
                      comWidth={54}
                      comHeight={54}
                      compLeft={0}
                    ...
                    >
                      <Img
                        src="images/img_delete_red_600.png"
                ...
                >
                  <Img
                    ...
                    className="absolute lg:h-[227px] xl:h-[259px] h-[291px] 2xl:h-[292px] 3xl:h-[350px] inset-[0] justify-center m-[auto] rounded-radius16 w-[86%]"
                    compId="43815:55405"
                    comWidth={459}
                    comHeight={291}
                    compLeft={37}
                  ...
                  />
                  <Column
                    className="absolute border-2 border-dashed border-indigo_50 items-end justify-end lg:p-[49px] xl:p-[56px] p-[64px] 3xl:p-[76px] rounded-radius4 w-[100%]"
                    compId="261"
                    comWidth={534}
                    comHeight={359}
                    compLeft={0}
                  ...
                  >
                    <Button
                      className="flex lg:h-[42px] xl:h-[49px] h-[54px] 2xl:h-[55px] 3xl:h-[65px] items-center justify-center lg:mt-[137px] xl:mt-[157px] mt-[177px] 3xl:mt-[212px] lg:w-[42px] xl:w-[48px] w-[54px] 3xl:w-[64px]"
                      compId="530:294532"
                      comWidth={54}
                      comHeight={54}
                      compLeft={0}
            ...
            >
              ...
              >
                <Img
                  ...
                  compId="I616:15255;533:294113;531:320466"
                  comWidth={18}
                  comHeight={16}
                  compLeft={0}
                  compRight={0}
              ...
              >
                <Img
                  ...
                  compId="I616:15255;614:13885;531:320955"
                  comWidth={16}
                  comHeight={18}
                  compLeft={0}
                  compRight={0}
              ...
              >
                <Img
                  ...
                  className="lg:h-[16px] xl:h-[18px] h-[20px] 2xl:h-[21px] 3xl:h-[25px] lg:w-[15px] xl:w-[17px] w-[20px] 3xl:w-[24px]"
                  compId="I616:15255;533:294557;533:294556"
                  comWidth={20}
                  comHeight={20}
                  compLeft={0}
                  compRight={0}
